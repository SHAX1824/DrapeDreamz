...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our DrapeDreamz!</h1>
                    <p>We have the best quality products for you. Your One Stop Destination for Fashion</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                <div id="shirts">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHIRTS/shirt1.jpg" alt="shirt1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tribal Print Shirt</h3>
                                    <p>Price: Rs.799.00</p>
                                    <select id="size1" name="size" class="form-control">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHIRTS/s5.avif" alt="shirt2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Vertical Stripe Shirt</h3>
                                    <p>Price: Rs. 899.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHIRTS/shirt4.jpg " alt="shirt3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pink Formal Shirt</h3>
                                    <p>Price: Rs. 649.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHIRTS/shirt5.avif" alt="shirt4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Aqua Resort Shirt</h3>
                                    <p>Price: Rs. 999.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/JEANS/jeanm.avif" alt="jeans1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Distress Jeans</h3>
                                    <p>Price: Rs. 1099.00</p>
                                    <select id="size2" name="size" class="form-control">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/JEANS/j6.avif" alt="jeans2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Skyblue Joggers</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/JEANS/j3.webp" alt="jeans3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Jeans</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/JEANS/jeans4.webp" alt="jeans4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>High Vest Jeans</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/T-SHIRT/tshirtcover.jpg" alt="Tshirt1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Backprint Tshirt</h3>
                                    <p>Price: Rs. 599.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/T-SHIRT/tshirt5.webp" alt="Tshirt2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Oversize Tshirt</h3>
                                    <p>Price: Rs. 599.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/T-SHIRT/t6.jpg" alt="Tshirt3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Washed Pink Tshirt</h3>
                                    <p>Price: Rs. 899.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/T-SHIRT/t2.jpg" alt="Tshirt4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Relax Fit Tshirt</h3>
                                    <p>Price: Rs. 699.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                ...
                <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/LEHENGA/le1.jpg" alt="Lehenga1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dark Pink Lehenga</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/LEHENGA/l2.jpg" alt="Lehenga2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Red Lehenga</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/LEHENGA/l4.jpg" alt="Lehenga3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Lehenga</h3>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/LEHENGA/l3.jpg" alt="Lehenga4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Green Lehenga</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TROUSERS/tmain.jpeg" alt="t1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Trouser</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TROUSERS/t5.avif" alt="t2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Grey Trouser</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TROUSERS/t4.jpg" alt="t3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>White Trouser</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TROUSERS/tr6.jpg" alt="t4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Multi Color Trouser</h3>
                                    <p>Price: Rs. 999.00</p>
                                    <select id="size2" name="size" class="form-control">
                                    <option value="28">28</option>
                                    <option value="30">30</option>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SALWAR/salwarmain.jpg" alt="sal1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Green White Salwar</h3>
                                    <p>Price: Rs.1499.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SALWAR/salwar2.webp" alt="sal2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Blue Grey Salwar</h3>
                                    <p>Price: Rs. 1099.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SALWAR/salwar3.webp" alt="sal3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Pink Salwar</h3>
                                    <p>Price: Rs. 899.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SALWAR/salwar6.jpg" alt="sal4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Red Salwar</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHORT PANTS/shorts.jpg" alt="short1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Denim Shorts</h3>
                                    <p>Price: Rs.399.00</p>
                                    <select id="size2" name="size" class="form-control">
                                    <option value="28">28</option>
                                    <option value="30">30</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHORT PANTS/short2.jpg" alt="short2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>White Denim Shorts</h3>
                                    <p>Price: Rs. 399.00</p>
                                    <select id="size2" name="size" class="form-control">
                                    <option value="28">28</option>
                                    <option value="30">30</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHORT PANTS/short3.jpg" alt="short3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Brown Denim Shorts</h3>
                                    <p>Price: Rs. 349.00</p>
                                    <select id="size2" name="size" class="form-control">
                                    <option value="28">28</option>
                                    <option value="30">30</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHORT PANTS/short4.jpg" alt="short4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Green Denim Shorts</h3>
                                    <p>Price: Rs. 449.00</p>
                                    <select id="size2" name="size" class="form-control">
                                    <option value="28">28</option>
                                    <option value="30">30</option>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ACCESSORIES/pendantsjpg.png" alt="acc1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Golden Pendant</h3>
                                    <p>Price: Rs.299.00</p>
                                    <select id="size3" name="size" class="form-control">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ACCESSORIES/a2.jpg" alt="acc2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Aviator Shades</h3>
                                    <p>Price: Rs. 499.00</p>
                                    <select id="size3" name="size" class="form-control">
                                    <option value="U">U</option>
                                </select>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ACCESSORIES/a4.webp" alt="acc3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black body bag</h3>
                                    <p>Price: Rs. 799.00</p>
                                    <select id="size3" name="size" class="form-control">
                                    <option value="U">U</option>
                                </select>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ACCESSORIES/a5.webp" alt="acc4">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TANK TOPS/tanktopmain.webp" alt="tank1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Blue Tank Top</h3>
                                    <p>Price: Rs.399.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TANK TOPS/t2.avif" alt="tank2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Tank Top</h3>
                                    <p>Price: Rs. 449.00</p>
                                    <select id="size1" name="size" class="form-control">
                                    <option value="S">S</option>
                                    <option value="M">M</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TANK TOPS/t3.webp" alt="tank3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pink Tank Top</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/TANK TOPS/t4.avif" alt="tank4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Red Tank Top</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHOES/shoes1.jpg" alt="shoes1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Red White Sneakers</h3>
                                    <p>Price: Rs.4999.00</p>
                                    <select id="size4" name="size" class="form-control">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHOES/shoes2.webp" alt="shoes2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Blue White Sneakers</h3>
                                    <p>Price: Rs. 4499.00</p>
                                    <select id="size4" name="size" class="form-control">
                                    <option value="UK7">UK7</option>
                                    <option value="UK8">UK8</option>
                                    <option value="UK9">UK9</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHOES/shoes5.jpeg" alt="shoes3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Faded Yellow Sneakers</h3>
                                    <p>Price: Rs. 2999.00</p>
                                    <select id="size4" name="size" class="form-control">
                                    <option value="UK7">UK7</option>
                                    <option value="UK8">UK8</option>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/SHOES/jordans6.png" alt="shoes4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Orange Taped Lows</h3>
